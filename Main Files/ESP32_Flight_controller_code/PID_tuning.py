"""
pid_tuner.py — Live PID Tuner for ESP32 Quadcopter (Unified GUI Version)
"""
...
def udp_listen():
    ...
    while True:
        try:
            ...
            # Map Yaw to index 4 and Throttle to index 5 safely
            ...
            with data_lock:
                ...
                # Only accept ESP32's streamed gains if 2 seconds have passed since our last command
...
def submit_command(text):
    ...
    try:
        ...
        cmd_upper = cmd.upper()
        with data_lock:
            # Lock out telemetry overwrites for 2 seconds
...
def update_plot(frame):
    ...
    # Draw fresh markers across all 3 charts
